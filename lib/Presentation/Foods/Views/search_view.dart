        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  RecentSearchItem(category: 'burger'),
                  RecentSearchItem(category: 'pizza'),
                  RecentSearchItem(category: 'drink'),
                  RecentSearchItem(category: 'taco'),
                  RecentSearchItem(category: 'burger'),
                ],
              ),
              const Gap(24),
                   ...
                   child: Row(
                     children: [
                       ...
                       Column(
                         ...
                         mainAxisAlignment: MainAxisAlignment.center,
                         children: [
                           Text('Burgers Truyền Thống',
                               style: TextStyles.bodyLargeSemiBold
                                   .copyWith(color: Pallete.neutral100, fontSize: getFontSize(FontSizes.large))),
                           const Gap(4),
                           Text('Nhà hàng Burger',
